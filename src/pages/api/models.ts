...
const models: ProductModel[] = [
  // Кровати (3)
  { id: 'bed-a', name: 'Кровать Loft A', slug: 'bed-loft-a', description: 'Металл + ЛДСП', basePrice: 29000, imageUrl: '/catalog/beds/loft-a.png', category: 'BEDS', finishes: ['дуб','орех','черный'] },
  { id: 'bed-b', name: 'Кровать Loft B', slug: 'bed-loft-b', description: 'С ящиками', basePrice: 34000, imageUrl: '/catalog/beds/loft-b.png', category: 'BEDS', finishes: ['дуб','белый'] },
  ...
  { id: 'desk-b', name: 'Стол Work B', slug: 'desk-work-b', description: 'Регулируемые опоры', basePrice: 21000, imageUrl: '/catalog/desks/work-b.png', category: 'DESKS', finishes: ['120×60','160×80'] },
  { id: 'desk-c', name: 'Стол Work C', slug: 'desk-work-c', description: 'С тумбой', basePrice: 24500, imageUrl: '/catalog/desks/work-c.png', category: 'DESKS', finishes: ['левый','правый'] },
]
